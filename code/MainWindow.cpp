...
MainWindow::MainWindow(){
    ...
    newAction = new QAction(QIcon(":/images/icon/new.png"), tr("&New..."), this);
    openAction = new QAction(QIcon(":/images/icon/open.png"), tr("&Open..."), this);
    saveAction = new QAction(QIcon(":/images/icon/save.png"), tr("&Save..."), this);
    fastAction = new QAction(QIcon(":/images/icon/fast.png"), tr("Goto Generation..."), this);
    editAction = new QAction(QIcon(":/images/icon/edit.png"), tr("&Edit mode"), this);
    ruleAction = new QAction(QIcon(":/images/icon/settings.png"), tr("&Rule..."), this);
    shaderAction = new QAction(QIcon(":/images/icon/color.png"), tr("&Shader..."), this);
    randomAction = new QAction(QIcon(":/images/icon/map.png"), tr("&Randomize..."), this);
    playAction = new QAction(QIcon(":/images/icon/play.png"), tr("Start"), this);
    stopAction = new QAction(QIcon(":/images/icon/stop.png"), tr("Stop"), this);
    graphAction = new QAction(QIcon(":/images/icon/grid.png"), tr("&Graphics..."), this);
    zoomInAction = new QAction(QIcon(":/images/icon/zoom in.png"), tr("Zoom in"), this);
    zoomOutAction = new QAction(QIcon(":/images/icon/zoom out.png"), tr("Zoom out"), this);
