...
template <typename ValType> Board<ValType>::Board(QWidget *parent): BoardBase(parent){
    ...
    hexH = hexHDef[zoomLevel];
    //
    hexMask[0][1] = QBitmap::fromImage(QImage(":/images/mask/hex0solid.png"));
    hexMask[1][0] = QBitmap::fromImage(QImage(":/images/mask/hex1border.png"));
    hexMask[1][1] = QBitmap::fromImage(QImage(":/images/mask/hex1solid.png"));
    hexMask[2][0] = QBitmap::fromImage(QImage(":/images/mask/hex2border.png"));
    hexMask[2][1] = QBitmap::fromImage(QImage(":/images/mask/hex2solid.png"));
    hexMask[3][0] = QBitmap::fromImage(QImage(":/images/mask/hex3border.png"));
    hexMask[3][1] = QBitmap::fromImage(QImage(":/images/mask/hex3solid.png"));
    hexMask[4][0] = QBitmap::fromImage(QImage(":/images/mask/hex4border.png"));
    hexMask[4][1] = QBitmap::fromImage(QImage(":/images/mask/hex4solid.png"));
}
